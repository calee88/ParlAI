...
if __name__ == '__main__':
    ...
    defopt = ['--log_file', 'src/data/SQuAD/exph13-fix-bi-concat-ldecay.log', '-t', 'squad', '--pretrained_model', 'src/data/SQuAD/exph13-fix-bi-concat-ldecay',
              '--embedding_file', 'src/data/SQuAD/glove.840B.300d.txt', '--dropout_rnn', '0.3', '--dropout_emb', '0.3', '--gpu', '0', '--qp_bottleneck', 'True',
              '--qp_birnn', 'True', '--qp_concat', 'True', '--lrate_decay', 'True', '--datatype', path]

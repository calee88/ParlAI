...
def add_cmdline_args(parser):
    ...
    agent.add_argument('--expnum', type=int, default=None)
   ...
   agent.add_argument('--embedding_dim', type=int, default=300,
    ...
    agent.add_argument('--hidden_size', type=int, default=128, help='Hidden size of RNN units')
    ...
    agent.add_argument('--lrate_decay', type=bool, default=True,
                        help='-----')

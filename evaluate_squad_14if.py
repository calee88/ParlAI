...
if __name__ == '__main__':
    ...
    defopt = ['--log_file', 'src/data/SQuAD/exph14-bt-gt-rt-if.log', '-t', 'squad', '--pretrained_model',
              'src/data/SQuAD/exph14-bt-gt-rt-if',
              '--embedding_file', 'src/data/SQuAD/glove.840B.300d.txt', '--dropout_rnn', '0.3', '--dropout_emb', '0.3',
              '--gpu', '0', '--qp_bottleneck', 'True',

...
case "$exp" in
	...
	;;
	qp-pp-basic) python $script --net rnet --model_file $exp_dir/$exp --dropout_rnn 0.3 --dropout_emb 0.3 --gpu $gpuid --qp_bottleneck True --qp_birnn True --qp_concat False --pp_bottleneck True --pp_birnn True --pp_concat False --hidden_size 128 --hidden_size_bottleneck 128 --rnn_type lstm
	;;
	...
	;;
	DEBUG2) python $script --model_file $exp_dir/$exp --gpu $gpuid --dropout_rnn 0.4 --dropout_emb 0.3 --tune_partial 0 --gpu $gpuid --add_char2word True --kernels '[(5,200)]' --nLayer_Highway 1
